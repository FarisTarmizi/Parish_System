...
<div class="content">
    ...
    <div class="slideshow-container">
        ...
        if (sizeof($pic) > 3) {
            foreach ($pic as $item) {
                if ($item['tarikhtamat'] > $current) {
                    ?>
                    <a>
                        <img class="mySlides" src="Ajk_masjid/upload/<?= $item['gambar']; ?>" width="600px" height="380px"
                            title="gambar masjid">
                    </a>
                <?php }
            }
            ...
            ?>
            <a><img class="mySlides" src="Ajk_masjid/upload/masjid1.JPG" width="600px" height="380px"
                    title="gambar masjid"></a>
            <?php
            foreach ($pic as $item) {
                if ($item['tarikhtamat'] > $current) {
                    ?>
                    <a>
                        <img class="mySlides" src="upload/<?= $item['gambar']; ?>" width="600px" height="380px"
                            title="gambar masjid" alt="profile">
                    </a>
                <?php }
            }
        } else {
            ...
            <a><img class="mySlides" src="Ajk_masjid/upload/masjid1.JPG" width="600px" height="380px"
                    title="gambar masjid"></a>
            <a><img class="mySlides" src="Ajk_masjid/upload/masjid2.JPG" width="600px" height="380px"
                    title="gambar masjid"></a>
            <a><img class="mySlides" src="Ajk_masjid/upload/masjid3.JPG" width="600px" height="380px"
                    title="gambar masjid"></a>
            <?php
            foreach ($pic as $item) {
                ?>
