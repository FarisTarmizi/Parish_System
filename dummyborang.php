    ...
    <form action="Confirm.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4 col-md-3">
            ...
            <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="bangsa">
                <option value=" " selected>Bangsa</option>
...
=======
            <div class="col-md-6 col-12 mt-4">
                <label for="gaji" class="form-label col-0">Gaji</label>
                <select class="form-select" aria-label="Default select example" name="gaji">
                    <option selected>Julat Gaji</option>
                    <option value="<2500"> kurang 2,500</option>
                    <option value="2501-3170">2,501-3,170</option>
...
>>>>>>> Stashed changes
        ...
        <div class="mt-4">
            ...
            <input type="text" class="form-control" id="namawaris" name="namawaris"
                placeholder="Nama Suami/Isteri/Penjaga">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control col-4 mb-4" id="lain" name="lain">
        </div>
        ...
        <input type="hidden" id="rowCountField" name="rowCount" value="1"><br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;<img src="captcha.php" alt="Captcha Image"><br><br>
        <div class="mb-3 col-md-3">
            <input type="text" class="form-control" name="captcha">
        </div>
        <input type="submit" value="Daftar" class="mb-5 btn btn-primary btn-lg"
    style="float: right; width: auto; max-width: 150px;">
