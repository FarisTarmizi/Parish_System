...
<div class="container" style="margin-top:5%;">
    ...
    <form action="Confirm.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <input type="text" class="form-control" id="namawaris" name="namawaris" placeholder="Jika berkaitan">
        </div>
        <div class="mb-3 col-4">
            <label for="icwaris" class="form-label">NO. KP Suami/Isteri/Penjaga</label>
            <input type="text" class="form-control" id="icwaris" name="icwaris" placeholder="tanpa-" minlength="12"
                maxlength="12">
        </div>
