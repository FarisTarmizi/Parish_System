...
if (isset($_POST['tapis'])) {
    ...
    if ($condition == "fakir miskin") {
        $query2 = "SELECT * FROM kariah WHERE status = 'Disahkan' AND gaji = '<2500' ";
        ...
        $query2 = "SELECT * FROM kariah WHERE  status = 'Disahkan' AND menghuni ='rsendiri'";
    } elseif ($condition == "rumah sewa") {
        $query2 = "SELECT * FROM kariah WHERE  status = 'Disahkan' AND menghuni ='rsewa'";
    ...
    <div class="col-12 ">
        ...
        <div class="card shadow p-3 mb-5 bg-body rounded">
            <div class="card-header">
                ...
                <form method="post" action="excel_kariah_test.php">
                    <input type="text" value="<?= $query2;?>" name="query2">
                    <input type="text" value="<?= $query3;?>" name="query3">
                    <input class="mt-3 float-right btn btn-success" name="export_filtered" value="Download Excel" type="submit">
                </form>
                    ...
                    <table class="table table-bordered table-striped data-table">
                        ...
                        if ($condition != "lelaki 15 tahun ke atas") {
                            ...
                            foreach ($data_tanggung as $data2) {
                                ...
                                $current = date('y');
                                $year = ($year > $current) ? $year + 1900 : $year + 2000;
                                $age = date('Y') - $year;
                                if ($age >= 15) {
                                    ?>
                                    <tr>
