...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh;
            background-image: url('assets_template/dist/img/black.png');
            background-size: contain; /* Adjusts the size of the background image */
            background-position: center center; /* Centers the background image */
            background-repeat: no-repeat; /* Prevents the image from repeating */
            background-color: rgba(255, 255, 255, 0.1); /* Adds a semi-transparent white background */
        }
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="Sumbangan.php">Rekod Sumbangan</a></li>
                            <li><a class="dropdown-item" href="Tambah_sumbangan.php">Tambah Rekod Sumbangan</a></li>
                            <li><a class="dropdown-item" href="jenis_sumbangan.php">Senarai Bantuan</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="Mobile_app.php">APPS</a></li>
                            <li><a class="dropdown-item" href="Password.php" onclick="return confirm('Anda Pasti Untuk Ubah Kata laluan?');">
                                    UBAH KATA LALUAN</a></li>
                        </ul>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link "
